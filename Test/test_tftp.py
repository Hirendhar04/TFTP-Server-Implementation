...
def getClient():
    import src.client.tftpclient as tftpclient
    return tftpclient.TFTPClient((HOST, PORT), "C:/Users/hiren/assignment3/tftpdir/read/")


@pytest.fixture(scope="module")
def putClient():
    import src.client.tftpclient as tftpclient
    return tftpclient.TFTPClient((HOST, PORT), "C:/Users/hiren/assignment3/tftpdir/write/")
